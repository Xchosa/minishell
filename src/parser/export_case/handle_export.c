...
// out of $hallo 
// typ is saved_var and it is a string-> 
//      ist splits eg." ls -al | grep  < makefile" into tokens
...
//             new_tokens = split_token_in_sub_token(token_lst->next, 
//                  node_to_jump_after);
